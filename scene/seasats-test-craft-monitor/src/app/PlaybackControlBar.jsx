...
export function PlaybackControlBar({
  ...
  const sourceLabel = textOrFallback(playbackWindow?.source, "未提供时间来源");
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "selected-vessel-summary", "aria-label": "所选舰艇" },
    ...
    React.createElement(
      ...
      React.createElement("span", null, "时间来源：", sourceLabel),
    ),
