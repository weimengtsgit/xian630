...
const defaultVessels = [
  ...
  { mmsi: "368913000", code: "CVN-73", name: "乔治·华盛顿号 (USS George Washington)", shortName: "华盛顿号", role: "航母" },
  // 使用方指定该艇的展示名称，关联结论中统一显示英文船名。
  { mmsi: "368926574", name: "SEAHAWK", role: "无人艇" },
  { mmsi: "369970970", name: "海猎号", role: "无人艇" },
  { mmsi: "366984000", code: "CVN-71", name: "西奥多·罗斯福号 (USS Theodore Roosevelt)", shortName: "罗斯福号", role: "航母" },
  ...
  { mmsi: "368776000", code: "CG-62", name: "罗伯特·斯莫尔斯号 (USS Robert Smalls)", role: "候选舰船" },
